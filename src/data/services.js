...
export const SERVICES = [
  {
    ...
    metaDescription:
      "Professionelle Gartengestaltung in Berlin & Brandenburg. Individuelle Planung, Neuanlage & Umgestaltung Ihres Gartens. ✓ Kostenlose Beratung ✓ 15+ Jahre Erfahrung",
    heroSubtitle: "Ihr Garten – Ihr Rückzugsort",
    features: [
      "Individuelle 3D-Gartenplanung",
      "Rasenanlage & Rollrasen",
      "Pflanzkonzepte & Staudenbeete",
      "Natursteinmauern & Trockenmauern",
      "Teichanlagen & Wasserspiele",
      "Stimmungsvolle Gartenbeleuchtung",
    ],
    benefits: [
      {
        title: "Maßgeschneidert",
        text: "Jeder Garten wird individuell nach Ihren Wünschen und den Gegebenheiten vor Ort geplant.",
      },
      {
        title: "Alles aus einer Hand",
        text: "Von der Planung bis zur Fertigstellung – ein Ansprechpartner für Ihr gesamtes Projekt.",
      },
      {
        title: "Nachhaltig",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Selbstverständlich! Gerade kleine Gärten profitieren enorm von einer durchdachten Planung, um den Raum optimal zu nutzen.",
      },
    ],
  },
  {
    slug: "gartenpflege",
    icon: Leaf,
    title: "Gartenpflege & Grünanlagenpflege",
    shortTitle: "Gartenpflege",
    excerpt:
    ...
    metaDescription:
      "Zuverlässige Gartenpflege in Berlin & Umgebung. Rasenmähen, Heckenschnitt, Unkrautbekämpfung & mehr. ✓ Regelmäßig oder einmalig ✓ Faire Preise",
    heroSubtitle: "Pflege, die man sieht",
    features: [
    ...
    benefits: [
      {
        title: "Zuverlässig",
        text: "Feste Pflegetermine, auf die Sie sich verlassen können – das ganze Jahr über.",
      },
      {
        title: "Flexibel",
  ...
  },
  {
    ...
    metaDescription:
      "Professionelle Pflasterarbeiten in Berlin & Brandenburg. Einfahrten, Gartenwege, Hofbefestigungen mit Naturstein & Betonstein. ✓ Meisterbetrieb ✓ Festpreisgarantie",
    heroSubtitle: "Solide Grundlagen für Ihren Außenbereich",
    features: [
      ...
      "Randeinfassungen & Bordsteine",
    ],
    benefits: [
      {
        title: "Langlebig",
        text: "Fachgerechter Unterbau und hochwertige Materialien sorgen für jahrzehntelange Haltbarkeit.",
      },
      {
        title: "Ästhetisch",
        text: "Große Auswahl an Materialien, Farben und Verlegemustern für ein harmonisches Gesamtbild.",
      },
      {
        title: "Normgerecht",
        text: "Alle Arbeiten nach aktuellen DIN-Normen und Richtlinien der Forschungsgesellschaft für Straßen- und Verkehrswesen.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Bei fachgerechtem Unterbau und qualitativem Material halten gepflasterte Flächen problemlos 25–30 Jahre und länger.",
      },
    ],
  },
  {
    slug: "terrassenbau",
    icon: Home,
    title: "Terrassenbau & Holzterrassen",
    ...
    heroSubtitle: "Wohnraum unter freiem Himmel",
    features: [
      "Holzterrassen (Bangkirai, Lärche, Douglasie)",
      "WPC-Terrassen (wartungsarm)",
      "Natursteinterrassen",
      "Unterkonstruktion & Fundamentarbeiten",
      "Stufen & Übergänge",
    ...
    benefits: [
      ...
      },
      {
        ...
        text: "Saubere Verarbeitung, passgenauer Zuschnitt und ein Ergebnis, das Sie begeistert.",
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    heroSubtitle: "Grenzen setzen – mit Stil",
    features: [
      "Doppelstabmattenzäune",
      "Holzzäune & Lamellenzäune",
      "Gabionen & Steinzäune",
      "Sichtschutzwände",
      "Tore & Eingangsbereiche",
      "Lebende Hecken als Sichtschutz",
    ],
    benefits: [
      {
        title: "Sicherheit",
        text: "Robuste Zäune schützen Ihr Grundstück vor unbefugtem Zutritt und geben Ihnen ein sicheres Gefühl.",
      },
      {
        title: "Design",
        text: "Moderne Materialien und Designs, die sich harmonisch in Ihren Garten einfügen.",
      },
      {
        title: "Beständig",
        text: "Wetterbeständige Materialien und fachgerechte Montage für lange Lebensdauer.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "In Berlin gilt grundsätzlich eine maximale Höhe von 2 Metern ohne Genehmigung. Es gibt jedoch Ausnahmen je nach Bezirk und Bebauungsplan.",
      },
    ],
  },
  {
    ...
    heroSubtitle: "Bäume in besten Händen",
    features: [
      "Kronenpflege & Kronenrückschnitt",
      "Totholzentfernung",
      "Baumfällung (auch Problemfällungen)",
    ...
    benefits: [
      ...
      {
        title: "Sicher",
        text: "Modernste Seilklettertechnik und Hubarbeitsbühnen für sichere Arbeiten in jeder Höhe.",
      },
      {
        title: "Schnell",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Kronenrückschnitte sind idealerweise im Herbst oder Winter durchzuführen. Totholzentfernungen können ganzjährig stattfinden.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "Automatische Bewässerungssysteme für Ihren Garten in Berlin. Installation, Planung & Wartung. ✓ Wassersparend ✓ App-Steuerung ✓ Professionelle Installation",
    heroSubtitle: "Intelligente Bewässerung für Ihren Garten",
    features: [
      "Rasensprenger & Versenkregner",
      "Tropfbewässerung für Beete",
      "Smart-Home-Anbindung",
      "Regenwassernutzung",
      "Zisternen & Regenspeicher",
      "Wartung & Winterservice",
    ],
    benefits: [
      {
        title: "Wassersparend",
        text: "Bis zu 50 % weniger Wasserverbrauch durch bedarfsgerechte, sensorgesteuerte Bewässerung.",
      },
      {
        title: "Komfortabel",
        text: "Steuern Sie Ihre Bewässerung bequem per Smartphone – von überall.",
      },
      {
        title: "Wertsteigernd",
        text: "Ein professionelles Bewässerungssystem steigert den Wert Ihrer Immobilie und erhält die Gartenqualität.",
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription:
      "Zuverlässiger Winterdienst in Berlin & Brandenburg. Schneeräumung, Streudienst & Eisbeseitigung für Gewerbe & Privat. ✓ 24h Bereitschaft ✓ Dokumentiert",
    heroSubtitle: "Sicher durch den Winter",
    features: [
      "Schneeräumung für Gehwege & Einfahrten",
      "Streudienst mit umweltschonendem Streugut",
      "Räumung von Parkplätzen & Zufahrten",
      "24-Stunden-Bereitschaft",
      "Dokumentierter Service (Räumprotokoll)",
      "Verträge für die gesamte Wintersaison",
    ],
    benefits: [
      {
        title: "Zuverlässig",
        text: "24-Stunden-Bereitschaft und Räumung ab dem ersten Schneefall – garantiert.",
      },
      {
        title: "Rechtssicher",
        text: "Lückenlose Dokumentation für Ihre Verkehrssicherungspflicht mit Räumprotokollen.",
      },
      {
        title: "Umweltbewusst",
        text: "Einsatz von umweltschonendem Streugut und salzarmer Räumung wo möglich.",
      },
    ],
    faq: [
      {
